<template>
    <section class="chat" ref="chat">
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <option v-for="month in months" :value="month">{{month < 10 ? '0' + month : month}}
                            </option>
                        </select>
                        <select
                                class="date__item"
        ...
        <Footer :view="midx === messages.length"/>
    </section>
</template>
...
<script>
    ...
    import {sendCLick, getSHA} from "../services/landAPI";
    ...
    export default {
        data() {
            return {
                ...
                defaultPhoneNumber: '0903120716',
                phoneNumber: null
            };
        },
        components: {Timer,Footer},
        props: ['person', 'clickID', 'skey'],
        mixins: [messages],
        methods: {
            scroll() {
            ...
            getPhoneNumber() {
                ...
                let key = this.skey;
                this.sendClick(clickID, key);
                getSHA(clickID, key).then((response) => {
