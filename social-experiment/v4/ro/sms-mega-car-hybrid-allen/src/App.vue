      ...
      <header class="header">
        <div class="wrapper">
          ...
          <div class="main" v-show="view === 0">
            ...
            <div v-if="footerObj" class="copy" v-html="footerObj.main_footer[footerGeo]">              
            </div>
          </div>
          <questionsList v-show="view === 1" @showPhoneForm="upView" />
          <div class="main" v-if="view === 3">
            <div class="result">
              <div class="main-title">
                <div class="main-title__inner-text animated infinite pulse">
                  Felicitări!
                  <br />Te-ai înregistrat cu succes.
                </div>
              </div>
              <div class="main-text">
                <div class="main-text__inner">
              ...
              <div class="main-small">
                <div class="main-small__inner">
                  ...
                  experiment. Numărul participanţilor este limitat, așa că
                  profită chiar acum de această ocazie unică.
                </div>
              </div>
              <template>
                <CallButton
            ...
            <div v-if="footerObj" class="section-copyright" id="summary-footer1" v-html="footerObj.second_footer[footerGeo]">             
            </div>
          </div>
        </div>
      </header>
