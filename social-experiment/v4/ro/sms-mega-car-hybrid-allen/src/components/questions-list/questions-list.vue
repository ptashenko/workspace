    ...
    <div class="main">
        <div class="questions-list">
            ...
            <div class="questions-list-container">
                <div class="questions-list-item" v-for="(question, index) in questions" :key="index" v-if="qID === index">
                    ...
                    <div class="list-item-questions">
                        <button type="button" v-for="(q, Qindex) in question.answers" :key="Qindex" v-html="q.text" @click="nextQuestion"></button>
                    </div>
                </div>
            </div>
        </div>
