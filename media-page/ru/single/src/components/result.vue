<template>
    <section class="result">
        <div class="header">
            ...
            <div class="text">
                Персональный астрологический прогноз поможет вам
                <span class="text--bold">
                достичь гармонии во всех сферах жизни и избежать уготованных судьбою неудач.
            </span>
            </div>
        </div>
        <div class="info" :class="{infoMainClosed: !bar}">
            <div class="info-header" @click.prevent="toggleBar">
                <div class="info-header__text">Ваш персональный гороскоп</div>
        ...
        <div class="footer" id="footer" style="overflow-y: scroll" :style="{height: footerContainerHeight + 'px'}">
            <div class="footer-content" ref="content">
                ...
                <div class="footer-text">
                    ...
                    <div class="footer-text--bold">
                        амулета на привлечение удачи и постоянное увеличение дохода!
                    </div>
                    <div class="last">
                        Я и подготовила его по вашей дате
                        рождения и сакральному числу.
                    </div>
                </div>
            ...
            <div class="copy">
                ...
                aveti
                acordul titularului cartelei si sunteti de acord cu acesti termeni si conditii. Prin apasarea tastei
                asculta
                mesajul veti fi redirectionat catre apelarea numarului sva aferent serviciului. Cost serviciu: 1.7 Euro
                +
                tva/minut in orange, vodafone, telekom fix si mobil. Acesta este un serviciu de divertisment. Prin
                accesarea
                serviciului sunteti de acord ca puteti primi mesaje de informare de la furnizorul serviciului legate de
                serviciile de divertisment oferite si noutati. In cazul utilizarii serviciului datele dvs. – Ex. Numarul
                de
                telefon, vor fi procesate doar in scopurile de mai sus. Furnizor serviciu: ABCMobile OÜ; Reg № 14710834;
                adresa: Harju maakond, Tallinn, Peterburi tee 71-318, 11415, Estonia. Support@abcmobile.com. Info
                serviciu
                voce: 0318260010, luni-vineri, 9:00-18:00.
            </div>
        </div>
    </section>
</template>
